      ...
      {isOpen && (
        <div className="fixed inset-0 z-100 flex justify-start overflow-hidden">
          ...
          <motion.div
            ...
            className="relative w-full max-w-md sm:max-w-lg h-full shadow-2xl z-10 flex flex-col"
            style={{
              background: "#FFFDF8",
              borderRight: "1px solid rgba(139,103,38,0.08)"
            }}
          >
            {/* Header / Banner Area */}
            ...
            <div
              ...
              style={{
                borderTop: "1px solid rgba(139,103,38,0.10)",
                background: "#FFFDF8"
              }}
            >
              <button
                ...
                disabled={isAdding}
                className={`w-full py-3 text-white rounded-3xl font-bold text-lg flex items-center justify-center gap-3 transition-all hover:scale-[1.02] active:scale-[0.98] ${isAdding ? 'opacity-70 cursor-not-allowed' : ''}`}
                style={{
