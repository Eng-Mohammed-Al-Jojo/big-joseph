                ...
                {totalItems > 0 && (
                    <motion.button
                        ...
                        style={{
                          ...
                          boxShadow: "0 16px 40px -8px rgba(139,103,38,0.50), 0 4px 12px -4px rgba(0,0,0,0.20)"
                        }}
                        ...
                        <div className="relative">
                            ...
                            <AnimatePresence mode="wait">
                                <motion.span
                                    ...
                                    className={`absolute -top-7 ${i18n.language === 'ar' ? '-left-4' : '-right-4'} text-[11px] w-7 h-7 flex items-center justify-center rounded-full border-2`}
                                >
                                    {totalItems}
                                </motion.span>
                            </AnimatePresence>
